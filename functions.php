...
function themeFields(Typecho_Widget_Helper_Layout $layout)
{
    ...
    // $cpright = new Typecho_Widget_Helper_Form_Element_Checkbox('cpright', 
    //     array(
    //         'postpage_footer_cp' => _t('post-page'),
    //         'clip_cp' => _t('Clipboard'),
    //         'reship' => _t('Reship')
    //      ),
    //     array(
    //         '',
    ...
    //     _t('Copyright')
    //     );
    // $layout->addItem($cpright);
    

    /* The  Customize Field of the article*/
    $postpage_footer_cp = new Typecho_Widget_Helper_Form_Element_Select('postpage_footer_cp', array(
        'display' => 'Enable',
        'hide' => 'Unable'
    ), 'display', _t('CopyRight_page'), _t('Display the copyright on the footer of the post-page.'));
    $layout->addItem($postpage_footer_cp);
    
    $clickboard_cp = new Typecho_Widget_Helper_Form_Element_Select('clickboard_cp', array(
        'display' => 'Enable',
        'hide' => 'Unable'
    ), 'display', _t('CopyRight_clickboard'), _t('Display the copyright when copy.'));
    $layout->addItem($clickboard_cp);
    
    $reship = new Typecho_Widget_Helper_Form_Element_Text('reship',  NULL, NULL,  _t('CopyRight_reship'), _t('Input the address.  Display the announcement of the reship.Ps:Use-"example.com">website_name'));
    $layout->addItem($reship);
    $draft_post_tip = new Typecho_Widget_Helper_Form_Element_Select('draft_post_tip', array(
        'display' => 'Enable',
        'hide' => 'Unable'
    ), 'display', _t('DraftPost_tip'), _t('Display the the tip of draft page.'));
    $layout->addItem($draft_post_tip);
